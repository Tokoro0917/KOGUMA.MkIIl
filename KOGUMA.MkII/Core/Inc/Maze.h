...
extern int G_MAZE_Explored[MAZE_SIZE][MAZE_SIZE];

extern int G_Maze_Row[MAZE_SIZE+1];
extern int G_Maze_Column[MAZE_SIZE+1];

extern int G_Robot_Direction;
extern int G_Robot_Lastaction;

extern int G_Maze_Flont;
extern int G_Maze_Back;
extern int G_Maze_Left;
extern int G_Maze_Right;

extern int G_Robot_MAZE_X;
extern int G_Robot_MAZE_Y;

extern int G_Maze_Row_Save[MAZE_SIZE+1];
extern int G_Maze_Column_Save[MAZE_SIZE+1];

extern int G_Step_Map[MAZE_SIZE][MAZE_SIZE];

extern int G_Short_Pass[MAX_STEP];
extern int G_Short_Pass_CP[MAX_STEP];
extern int G_Short_Pass_NANAME[MAX_STEP];

extern int G_Known_Pass[MAX_STEP];
